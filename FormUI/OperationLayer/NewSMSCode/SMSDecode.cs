...
namespace FormUI.OperationLayer.NewSMSCode
{
    ...
    public partial class SMS
    {
        ...
        ///     Byte[]类型：二进制内容
        /// </returns>
        private static Object UserDataDecoding(String data, Int32 Index, Boolean UDHI = false,
                                               EnumDCS DCS = EnumDCS.UCS2)
        {
            ...
            if (DCS == EnumDCS.UCS2)
            {
                ...
                var sb = new StringBuilder(CharNumber);
        ...
        {
            var Bit7Array = new Byte[Septets];
        ...
        {
            var sb = new StringBuilder(Bit7Array.Length);
