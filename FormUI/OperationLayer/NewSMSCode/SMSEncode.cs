...
namespace FormUI.OperationLayer.NewSMSCode
{
    ...
    public partial class SMS
    {
        ...
        public String[] PDUEncoding(String SCA, String DA, Object UDC, PDUUDH[] UDH = null, EnumDCS DCS = EnumDCS.UCS2)
        {
            ...
            if (UDC is String)
            {
                ...
                if (CSMUDC.Count > 1)
                {
                    ...
                    // 生成短信编码序列
                    var CSMSeries = new String[CSMUDC.Count];
        ...
        private static String UDHEncoding(PDUUDH[] UDH, out Int32 UDHL)
        {
            ...
            var sb = new StringBuilder((UDHL + 1) << 1);
        ...
        private static String UDCEncoding(String UDC, out Int32 UDCL, Int32 UDHL = 0, EnumDCS DCS = EnumDCS.UCS2)
        {
            ...
            else
            {
                ...
                var sb = new StringBuilder(UDCL << 1);
        ...
        {
            var Bit7Array = new Byte[UDC.Length << 1];
        ...
        private static String BIT7Pack(Byte[] Bit7Array, Int32 UDHL)
        {
            ...
            var sb = new StringBuilder(PackLen << 1);
        ...
        private static String SCAEncoding(String SCA)
        {
            ...
            var sb = new StringBuilder(SCA.Length + 5);
            Int32 Index = 0;
            if (SCA.StartsWith("+"))
            {
                // 国际号码
        ...
        private static String DAEncoding(String DA)
        {
            ...
            var sb = new StringBuilder(DA.Length + 5);
            Int32 Index = 0;
            if (DA.StartsWith("+"))
            {
                // 国际号码
        ...
        /// </remarks>
        private String SoloPDUEncoding(String SCA, String DA, Object UDC, PDUUDH[] UDH = null,
                                       EnumDCS DCS = EnumDCS.UCS2)
        {
