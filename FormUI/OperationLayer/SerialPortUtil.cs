...
namespace FormUI.OperationLayer
{
    ...
    public class SerialPortUtil
    {
        ...
        public bool Open(string portName, string baudRate)
        {
            ...
            comPort.BaudRate =
                (int) (_baudRate = (SerialPortBaudRates) Enum.Parse(typeof (SerialPortBaudRates), baudRate));
        ...
        public SerialPortUtil(string name, SerialPortBaudRates baud, Parity par, SerialPortDatabits dBits,
                              StopBits sBits)
        {
            _portName = name;
            _baudRate = baud;
