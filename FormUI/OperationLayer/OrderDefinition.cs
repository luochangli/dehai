...
namespace FormUI.OperationLayer
{
    ...
    public class OrderDefinition
    {
        ...
        public static void SetPlayStyle(ComboBox comboBox)
        {
            ...
            foreach (object value in Enum.GetValues(typeof (PlayStyle)))
            {
        ...
        {
            comboBox.Items.Clear();
            foreach (object value in Enum.GetValues(typeof (MusicNo)))
            {
        ...
        {
            comboBox.Items.Clear();
            foreach (object value in Enum.GetValues(typeof (Voice)))
            {
                comboBox.Items.Add(((int) value).ToString());
            }
        }
        ...
        /// <returns></returns>
        public string OpenCTerminal(string terminalName, string phone, string termianlType1, string terminalType2,
                                    string terminalType3)
        {
