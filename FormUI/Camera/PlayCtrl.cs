...
namespace FormUI.Camera
{
    ...
    *************************************************/
        ...
        [DllImport(@"\PlayCtrl.dll")]
        public static extern bool PlayM4_SetDisplayRegion(int nPort, uint nRegionNum, ref tagRECT pSrcRect, System.IntPtr hDestWnd, [MarshalAs(System.Runtime.InteropServices.UnmanagedType.Bool)] bool bEnable);
