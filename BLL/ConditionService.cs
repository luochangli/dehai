...
namespace TomorrowSoft.BLL
{
    ...
    {
        private readonly ConditionRepository dal;

        public ConditionService()
        {
            dal = new ConditionRepository();
        }
        ...
        ///     获得数据列表
        /// </summary>
        public List<Condition> GetModelList(string strWhere)
        {
        ...
        ///     获得数据列表
        /// </summary>
        public List<Condition> DataTableToList(DataTable dt)
        {
            var modelList = new List<Condition>();
