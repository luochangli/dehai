...
namespace TomorrowSoft.BLL
{
    ...
    /// </summary>
    public class GroupMemoryPlayService
    {
        ...
        ///     获得数据列表
        /// </summary>
        public List<GroupMemoryPlay> GetModelList(string strWhere)
        {
        ...
        ///     获得数据列表
        /// </summary>
        public List<GroupMemoryPlay> DataTableToList(DataTable dt)
        {
            var modelList = new List<GroupMemoryPlay>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                GroupMemoryPlay model;
